...
<div class="mb-3">
  ...
  <input type="checkbox" name="completed" class="form-check=input" id="completed" placeholder="completed" name="completed" value="true" <c:out value="${todo.completed?'checked':''}" /> >
</div>
<div class="mb-3">
